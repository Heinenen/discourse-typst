...
function uploadSvgFile(file) {
    ...
    formData.append("type", "composer"); // required by Discourse
...
export default apiInitializer("1.13.0", (api) => {
    ...
    api.modifyClass("controller:composer", {
        ...
        async save(ignore, event) {
            ...
            // try {
            //     const upload = uploadSvgFile(file);
            //     console
            //     if (upload?.url) {
            //     }
            // } catch (err) {
    ...
    console.log(api._resolveClass("controller:composer"))
    // api.composerBeforeSave((composerModel) => {
